...
class MenuApp:
    ...
    def create_menu(self):
        ...
        procesos_consultas.add_command(label='Preparar Nuevo Campeonaro', command=lambda: self.change_frame('preparar_campeonato'))
        procesos_consultas.add_command(label='Crear de Campeonato', command=lambda: self.change_frame('crear_campeonato'))
